const TodoListItem = ({ id, title, desc, done, index, handleDelete, handleDone }) => {
	return (
		<div className="col-12 col-md-6">
			<li className="list-group-item mb-1 py-3 bg-yellow border-0 rounded">
				...
				<div className="form-check text-right">
					<input className="form-check-input" onClick={() => handleDone(id)} type="checkbox" value="" id={`checkDone-${index}`} />
					<label className="form-check-label" htmlFor={`checkDone-${index}`}>
						Done
					</label>
				</div>
			</li>
